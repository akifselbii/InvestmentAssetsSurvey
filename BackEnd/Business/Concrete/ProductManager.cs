...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        public ProductManager(IProductDal productDal,ICategoryService categoryService)//13-2:43:23
        {
        ...
        public IDataResult<List<Product>> GetProductNameByCategoryId(int categoryId, string productName)
        {
        ...
        {
            var result = _productDal.GetAll(p => p.ProductName == productName).Any();//13-1:51:00
            if (result)
            {
